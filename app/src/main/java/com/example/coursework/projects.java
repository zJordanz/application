...
//When button " " is clicked it will go to " " activity
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent2 = new Intent(projects.this, Mob_rem1.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent2 = new Intent(projects.this, Mob_rem2.class);
                startActivity(myintent2);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent2 = new Intent(projects.this, Mob_rem3.class);
                startActivity(myintent2);
        ...
        items = Filehelper7.readData(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add_btn:
                ...
                itemET.setText("");
                Filehelper7.writeData(items, this);
