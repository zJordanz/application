...
public class Reminders2 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
...
// Gives buttons and lists identifiers linked to their Id
        ...
        items = FileHelper6.readData(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add_btn:
                ...
                itemET.setText("");
                FileHelper6.writeData(items, this);
