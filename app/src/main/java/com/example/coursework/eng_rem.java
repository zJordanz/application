...
public class eng_rem extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
// Name of variables
    ...
    protected void onCreate(Bundle savedInstaneState) {
        ...
        setContentView(R.layout.activity_eng_rem);
        //File helper stores the data of the lists
        itemET = findViewById(R.id.item_edit_text);
        btn= findViewById(R.id.add_btn);
        itemsList =findViewById(R.id.items_list);

        items = FileHelper8.readData(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add_btn:
                ...
                itemET.setText("");
                FileHelper8.writeData(items, this);
